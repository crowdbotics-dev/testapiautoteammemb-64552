...
## Project Structure
    ...
    ├── testapiautoteammemb_64552  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_64552`
...
2. Clone this repo and `cd testapiautoteammemb_64552`
